...
{
    public partial class ReportPengunjung : Form
    {
        // Connection string to your database
        Koneksi kn = new Koneksi();
        string strKonek = "";
        public ReportPengunjung()
        {
            InitializeComponent();
            strKonek = kn.connectionString();
        }

        private void ReportPengunjung_Load(object sender, EventArgs e)
        {
        ...
        private void SetupReportViewer()
        {
            ...
            string query = @"
                SELECT PengunjungID, NamaPengunjung, Kontak
                FROM Pengunjung";
            ...
            string reportPath = System.IO.Path.Combine(Application.StartupPath, "Pengunjung.rdlc");
